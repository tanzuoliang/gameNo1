...
bool js_cocos2dx_EventCustom_getEventData(JSContext *cx, uint32_t argc, jsval *vp);
...
bool js_cocos2dx_ActionManager_updateSpeed(JSContext *cx, uint32_t argc, jsval *vp);
