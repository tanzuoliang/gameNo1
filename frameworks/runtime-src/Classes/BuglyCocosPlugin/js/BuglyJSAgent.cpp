...
void BuglyJSAgent::registerJSFunctions(JSContext *cx, BLYJSObject global){
    ...
    //JS_DefineFunction(cx, global, "initCrashReport", BuglyJSAgent::initCrashReport, 2, JSPROP_READONLY | JSPROP_PERMANENT);
}
...
//bool BuglyJSAgent::initCrashReport(JSContext *cx, unsigned argc, JS::Value *vp){
//    CCLOG("-> %s", __PRETTY_FUNCTION__);
//
//    if (argc > 1) {
//#if COCOS2D_VERSION >= 0x00030500
...
//        const char *appId;
//        int isDebug;
//        jsval_to_charptr(cx, args.get(0), &appId);
//        jsval_to_int(cx, args.get(1), &isDebug);
//        CrashReport::initCrashReport(appId, isDebug == 1 ? true : false);
//
//        args.rval().setUndefined();
//
//#else
...
//        const char *appId;
//        int isDebug;
//        jsval_to_charptr(cx, *argvp++, &appId);
//        jsval_to_int(cx, *argvp++, &isDebug);
//
//        CrashReport::initCrashReport(appId, isDebug == 1 ? true : false);
//#endif
//    }
