...
#include "sdk/jsb_sdk_auto.hpp"
#include "sdk/SDKPlatform.h"
#include "sdk/SDKCallback.h"
...
static void registerOtherJs_auto(JSContext* cx,JS::HandleObject obj)
{

#if CC_TARGET_PLATFORM == CC_PLATFORM_ANDROID || CC_TARGET_PLATFORM == CC_PLATFORM_IOS
    JS::RootedObject ns(cx);
    get_or_create_js_obj(cx, obj, "sdk", &ns);
    
    js_register_jsb_maple_auto_sdk(cx,ns);
...
bool AppDelegate::applicationDidFinishLaunching()
{
    ...
    if(!glview) {
        ...
        glview = cocos2d::GLViewImpl::create("cubeWar");
#else
//        glview = cocos2d::GLViewImpl::createWithRect("tank", Rect(0,0,960,640));
        glview = cocos2d::GLViewImpl::createWithRect("cubeWar", cocos2d::Rect(0,0,448,800));
#endif
    ...
    searchPaths.insert(iter, cocos2d::FileUtils::getInstance()->getWritablePath()+"/upgrade_data/");
    ...
    sc->addRegisterCallback(register_all_cocos2dx_ty);
    sc->addRegisterCallback(registerOtherJs_auto);
