...
public:
    ...
    // for payment
    virtual void onPaymentEvent(std::string &identifier, IOSiAPPaymentEvent event, int quantity,std::string identifierId = "") = 0;
};
...
public:
    ...
    void paymentWithProduct(IOSProduct *iosProduct,std::string& applicationusername,int quantity = 1);
